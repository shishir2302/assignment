...
<div class="wp-block-group has-light-color-background-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"left":"60px"}}}} -->
    <div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center"} -->
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":3625,"sizeSlug":"full","linkDestination":"none","className":"blockbooster-flip-up"} -->
            <figure class="wp-block-image size-full blockbooster-flip-up"><img src="<?php echo esc_url($blockbooster_images[0]) ?>" alt="" class="wp-image-3625" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    ...
    <div class="wp-block-columns are-vertically-aligned-center" style="margin-top:100px"><!-- wp:column {"verticalAlignment":"center"} -->
        ...
        <!-- wp:column {"verticalAlignment":"center"} -->
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":3625,"sizeSlug":"full","linkDestination":"none","className":"blockbooster-flip-up"} -->
            <figure class="wp-block-image size-full blockbooster-flip-up"><img src="<?php echo esc_url($blockbooster_images[1]) ?>" alt="" class="wp-image-3625" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    </div>
